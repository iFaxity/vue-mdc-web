...
var title$1 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c(_vm.tag,{tag:"component",staticClass:"mdc-dialog__header__title"},[_vm._t("default")],2)},staticRenderFns: [],
  name: "MdcDialogTitle",
  props: {
    level: {
      type: [Number, String],
...
const downEvent = checkEvent("down");
const upEvent = checkEvent("up");
const moveEvent = checkEvent("move");

const supportsCssVars = window.CSS && window.CSS.supports && window.CSS.supports("--css-var", 0);
function passiveOpts() {
  return supportsPassive$1 ? { passive: true } : null;
}
...
var slider = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"mdc-slider",class:_vm.cssClasses,attrs:{"role":"slider","aria-label":_vm.label,"tabindex":_vm.disabled ? false : "0","aria-disabled":_vm.disabled,"aria-valuemin":_vm.min,"aria-valuemax":_vm.max,"aria-valuenow":_vm.value},on:{"blur":_vm.onBlur,"focus":_vm.onFocus,"keydown":_vm.keyDown,"mousedown":_vm.onDown,"pointerdown":_vm.onDown,"touchstart":_vm.onDown}},[_c('div',{staticClass:"mdc-slider__track-container"},[_c('div',{staticClass:"mdc-slider__track",style:(_vm.styleTrack)}),(_vm.discrete === "markers")?_c('div',{staticClass:"mdc-slider__track-marker-container"},_vm._l((_vm.markers),function(item){return _c('div',{staticClass:"mdc-slider__track-marker"})})):_vm._e()]),_c('div',{staticClass:"mdc-slider__thumb-container",style:(_vm.styleThumbContainer),on:{"transitionend":function($event){_vm.inTransit = false;}}},[(typeof _vm.discrete === "string")?_c('div',{staticClass:"mdc-slider__pin"},[_c('span',{staticClass:"mdc-slider__pin-value-marker"},[_vm._v(_vm._s(_vm.innerValue))])]):_vm._e(),_c('svg',{staticClass:"mdc-slider__thumb",attrs:{"width":"21","height":"21"}},[_c('circle',{attrs:{"cx":"10.5","cy":"10.5","r":"7.875"}})]),_c('div',{staticClass:"mdc-slider__focus-ring"})])])},staticRenderFns: [],
  ...
  methods: {
    setValueFromEvent(e) {
      ...
      let pctComplete = clamp(0, 1, xPos / this.rect.width);
...
var section = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"mdc-toolbar__section",class:_vm.cssClasses,attrs:{"role":"toolbar"}},[_vm._t("default")],2)},staticRenderFns: [],
  ...
  computed: {
    cssClasses() {
      const classes = { "mdc-toolbar__section--shrink-to-fit": this.shrink };
      if(this.align) {
...
var title$2 = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('span',{staticClass:"mdc-toolbar__title"},[_vm._t("default")],2)},staticRenderFns: [],
  ...
  methods: {
    ...
    windowScroll(e) {
      ...
      if(this.fixed === "lastrow") {
        ...
        const y = clamp$1(0, calc.toolbarHeight, calc.scroll - height);
    ...
    calculate() {
      ...
      const ratio = clamp$1(0, 1, 1 - (scroll / diffHeight));
...
var Test = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('mdc-toolbar',{attrs:{"fixed":"lastrow","waterfall":"","flexible":""}},[_c('mdc-toolbar-row',[_c('mdc-toolbar-section',{attrs:{"align":"start"}},[_c('mdc-toolbar-menu-icon',{on:{"click":function($event){_vm.$refs.drawer.open();}}})],1)],1),_c('mdc-toolbar-row',[_c('mdc-toolbar-section',{attrs:{"align":"start"}},[_c('mdc-toolbar-title',[_vm._v("Material Components In Vuejs")])],1),_c('mdc-toolbar-section',{attrs:{"align":"end"}},[_c('mdc-toolbar-icon',{attrs:{"aria-label":"Download","alt":"Download"}},[_vm._v("file_download ")]),_c('mdc-toolbar-icon',{attrs:{"aria-label":"Print this page","alt":"Print this page"}},[_vm._v("print")]),_c('mdc-toolbar-icon',{attrs:{"aria-label":"Bookmark this page","alt":"Bookmark this page"}},[_vm._v("bookmark")])],1)],1)],1),_c('main',{staticStyle:{"height":"2000px"}},[_c('h2',[_vm._v("Button")]),_c('mdc-button',[_vm._v("Click me")]),_c('mdc-button',{attrs:{"icon":"accessibility"}},[_vm._v("Icon Button")]),_c('mdc-button',{attrs:{"raised":""}},[_vm._v("Raised button")]),_c('mdc-button',{attrs:{"unelevated":""}},[_vm._v("Unelevated button")]),_c('mdc-button',{attrs:{"stroked":""}},[_vm._v("Stroked button")]),_c('mdc-button',{attrs:{"dense":""}},[_vm._v("Dense button")]),_c('mdc-button',{attrs:{"compact":"compact"}},[_vm._v("Compact button")]),_c('mdc-button',{attrs:{"secondary":""}},[_vm._v("Secondary button")]),_c('mdc-button',{attrs:{"link":"#"}},[_vm._v("Link button")]),_c('h2',[_vm._v("Fab")]),_c('h2',[_vm._v("IconToggle")]),_c('h2',[_vm._v("Dialog")]),_c('mdc-button',{attrs:{"raised":""},on:{"click":function($event){_vm.$refs.dialog.open();}}},[_vm._v("Show Dialog")]),_c('p',[_vm._v("Result: "+_vm._s(_vm.dialogResult))]),_c('mdc-dialog',{ref:"dialog",on:{"action":_vm.dialogAction}},[_c('mdc-dialog-title',{attrs:{"slot":"header"},slot:"header"},[_vm._v("Test dialog")]),_vm._v("This is just a test dialog click accept or decline to close the window")],1),_c('h2',[_vm._v("Slider")]),_c('mdc-slider',{attrs:{"discrete":"","min":0,"max":50,"step":1},on:{"input":_vm.onSliderInput},model:{value:(_vm.sliderValue),callback:function ($$v) {_vm.sliderValue=$$v;},expression:"sliderValue"}}),_c('p',[_vm._v("Slider@change "+_vm._s(_vm.sliderValue)+" Slider@input "+_vm._s(_vm.sliderInput))]),_c('h2',[_vm._v("Checkbox")]),_c('mdc-checkbox',{attrs:{"indeterminate":""},model:{value:(_vm.checked),callback:function ($$v) {_vm.checked=$$v;},expression:"checked"}}),_c('p',[_vm._v("Checked: "+_vm._s(_vm.checked))]),_c('h2',[_vm._v("Textfield")]),_c('mdc-textfield',{attrs:{"box":"","icon":"mail","click-icon":"","trailing-icon":"","pattern":"[A-Za-z]{5,10}"},model:{value:(_vm.myName),callback:function ($$v) {_vm.myName=$$v;},expression:"myName"}},[_vm._v("Enter your name")]),_c('mdc-textfield-helptext',{attrs:{"validation":""}},[_vm._v("Enter a name between 5 and 10 characters")])],1)],1)},staticRenderFns: [],
  name: "Test",
  data() {
    return { 
